...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--dataroot', type=str, default='/data/k003166', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--batchSize', type=int, default=16, help='input batch size') #16
        ...
        parser.add_argument('--input_nc', type=int, default=4, help='# of input image channels') # 4
        ...
        parser.add_argument('--which_model_netG', type=str, default='resnet_6blocks', help='selects model to use for netG')#unet
        parser.add_argument('--n_layers_D', type=int, default=1, help='only used if which_model_netD==n_layers')
        parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--name', type=str, default='pet-demo-radius2', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='/data/k003166/90-release/01-TICCGAN/checkpoints', help='models are saved here')
        ...
        parser.add_argument('--w_nnm', default=0, type=float, help='weight of the tv loss')
        ...
        parser.add_argument('--w_tv', default=0.1, type=float, help='weight of the tv loss')

        parser.add_argument('--vgg_tp', default=-1, type=int, help='weight of the tv loss')

        parser.add_argument('--use_condition', default=1, type=int, help='1 means add condition in discriminator')
